...
import { Chat, WAPresence, LegacySocketConfig, WABusinessProfile, ChatModification, WAMessageKey } from "../Types";
declare const makeChatsSocket: (config: LegacySocketConfig) => {
     ...
     */
    chatModify: (modification: ChatModification, jid: string, chatInfo: Pick<Chat, 'mute' | 'pin'>, index?: WAMessageKey) => Promise<void | {
        status: number;
    }>;
    /**
