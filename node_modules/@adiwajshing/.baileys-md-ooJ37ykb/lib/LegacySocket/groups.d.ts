...
import { LegacySocketConfig, ParticipantAction, GroupMetadata } from "../Types";
declare const makeGroupsSocket: (config: LegacySocketConfig) => {
    ...
    messageInfo: (jid: string, messageID: string) => Promise<import("../Types").MessageInfo>;
    downloadMediaMessage: (message: import("../Types").WAProto.IWebMessageInfo, type?: "buffer" | "stream") => Promise<Buffer | import("stream").Readable>;
    ...
    loadMessageFromWA: (jid: string, id: string) => Promise<import("../Types").WAProto.IWebMessageInfo>;
    ...
    chatModify: (modification: import("../Types").ChatModification, jid: string, chatInfo: Pick<import("../Types").Chat, "mute" | "pin">, index?: import("../Types").WAProto.IMessageKey) => Promise<void | {
        status: number;
    }>;
