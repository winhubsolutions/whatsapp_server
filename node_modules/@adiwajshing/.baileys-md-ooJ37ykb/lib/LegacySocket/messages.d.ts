...
import { Chat, WAMessageCursor, WAMessage, LegacySocketConfig, AnyMessageContent, MiscMessageGenerationOptions, WAUrlInfo, MessageInfo } from "../Types";
...
declare const makeMessagesSocket: (config: LegacySocketConfig) => {
    ...
    chatModify: (modification: import("../Types").ChatModification, jid: string, chatInfo: Pick<Chat, "mute" | "pin">, index?: proto.IMessageKey) => Promise<void | {
        status: number;
    }>;
