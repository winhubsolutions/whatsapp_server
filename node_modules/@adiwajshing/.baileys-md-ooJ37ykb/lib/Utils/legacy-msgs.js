...
exports.useSingleFileLegacyAuthState = exports.computeChallengeResponse = exports.validateNewConnection = exports.decodeWAMessage = exports.newLegacyAuthCreds = void 0;
...
const decodeWAMessage = (message, auth, fromMe = false) => {
    ...
    if (commaIndex < 0)
        throw new boom_1.Boom('invalid message', { data: message }); // if there was no comma, then this message must be not be valid
