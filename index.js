...
import makeWASocket, { default.WASocket, AuthenticationState, DisconnectReason, AnyMessageContent, BufferJSON, initInMemoryKeyStore, delay } from '@adiwajshing/baileys-md'

(async() => {
    let sock = WASocket?WASocket:undefined;
    // load authentication state from a file
    const loadState = () => {
        let state = AuthenticationState?AuthenticationState:undefined;
        try {
